...
export const CATEGORIES: Category[] = [
  ...
  {id:"populationGrowth",name:"Fastest population growth",shortName:"Population growth",indicator:"SP.POP.GROW",icon:"📈",unit:"%",family:"Population",direction:"high",description:"Annual population growth",decimals:2,minimumYear:2022,requireCommonYear:true,expectedRange:[-10,10]},
  ...
  {id:"urban",name:"Most urbanized",shortName:"Urban population",indicator:"SP.URB.TOTL.IN.ZS",icon:"🏢",unit:"%",family:"Population",direction:"high",description:"Share of population living in urban areas",decimals:1,expectedRange:[0,100]},
  {id:"rural",name:"Largest rural population share",shortName:"Rural population",indicator:"SP.RUR.TOTL.ZS",icon:"🏡",unit:"%",family:"Population",direction:"high",description:"Share of population living in rural areas",decimals:1,expectedRange:[0,100]},
  ...
  {id:"gdpGrowth",name:"Fastest economic growth",shortName:"GDP growth",indicator:"NY.GDP.MKTP.KD.ZG",icon:"🚀",unit:"%",family:"Economy",direction:"high",description:"Annual real GDP growth",decimals:2,minimumYear:2022,requireCommonYear:true,expectedRange:[-50,50]},
  ...
  {id:"forestPct",name:"Highest forest coverage",shortName:"Forest coverage",indicator:"AG.LND.FRST.ZS",icon:"🌳",unit:"%",family:"Land",direction:"high",description:"Forest area as a share of land area",decimals:1,expectedRange:[0,100]},
  {id:"leastForest",name:"Least forest coverage",shortName:"Least forest",indicator:"AG.LND.FRST.ZS",icon:"🪵",unit:"%",family:"Land",direction:"low",description:"Lowest forest share of land area",decimals:1,expectedRange:[0,100]},
  ...
  {id:"internet",name:"Highest internet usage",shortName:"Internet usage",indicator:"IT.NET.USER.ZS",icon:"🌐",unit:"%",family:"Technology",direction:"high",description:"Individuals using the internet",decimals:1,expectedRange:[0,100]},
  ...
  {id:"waterStress",name:"Highest agricultural share of freshwater withdrawals",shortName:"Agricultural water share",indicator:"ER.H2O.FWAG.ZS",icon:"🚰",unit:"% for agriculture",family:"Environment",direction:"high",description:"Agriculture share of total freshwater withdrawals",decimals:1},
