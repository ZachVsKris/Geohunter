...
export const CATEGORIES: Category[] = [
  ...
  wb({id:"mobile",name:"Most mobile subscriptions",shortName:"Mobile subscriptions",indicator:"IT.CEL.SETS.P2",icon:"📱",unit:"per 100 people",family:"Technology",direction:"high",description:"Subscriptions per 100 people",decimals:1}),
  ...
  wb({id:"co2Total",name:"Highest total CO₂ emissions",shortName:"CO₂ emissions",indicator:"EN.ATM.CO2E.KT",icon:"🏭",unit:"kt CO₂",family:"Environment",direction:"high",description:"Total emissions, kilotonnes of CO₂"}),
  wb({id:"co2PerCapita",name:"Highest CO₂ emissions per person",shortName:"CO₂ per capita",indicator:"EN.ATM.CO2E.PC",icon:"☁️",unit:"metric tons/person",family:"Environment",direction:"high",description:"Metric tons of CO₂ per person",decimals:2}),
  ...
  wb({id:"servicesShare",name:"Largest services sector",shortName:"Services",indicator:"NV.SRV.TOTL.ZS",icon:"🏦",unit:"% of GDP",family:"Economy",direction:"high",description:"Services value added, percent of GDP",decimals:1,expectedRange:[0,100]}),
  wb({id:"industryShare",name:"Largest industrial sector",shortName:"Industry",indicator:"NV.IND.TOTL.ZS",icon:"🏗️",unit:"% of GDP",family:"Economy",direction:"high",description:"Industry value added, percent of GDP",decimals:1,expectedRange:[0,100]}),
  ...
  wb({id:"fixedTelephone",name:"Most fixed telephone subscriptions",shortName:"Fixed telephones",indicator:"IT.MLT.MAIN.P2",icon:"☎️",unit:"per 100 people",family:"Technology",direction:"high",description:"Subscriptions per 100 people",decimals:1}),
  ...
  wb({id:"methane",name:"Highest methane emissions",shortName:"Methane emissions",indicator:"EN.ATM.METH.KT.CE",icon:"🌫️",unit:"kt CO₂ equivalent",family:"Environment",direction:"high",description:"Total emissions, kilotonnes of CO₂ equivalent"}),
