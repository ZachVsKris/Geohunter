...
export const CATEGORIES: Category[] = [
  ...
  tourism({id:"touristArrivals",name:"Most international tourist arrivals",shortName:"Tourist arrivals",indicator:"ST.INT.ARVL",icon:"🧳",unit:"arrivals",family:"Tourism",direction:"high",description:"International inbound tourist arrivals"}),
  tourism({id:"tourismReceipts",name:"Highest tourism receipts",shortName:"Tourism receipts",indicator:"ST.INT.RCPT.CD",icon:"🏖️",unit:"USD",family:"Tourism",direction:"high",description:"International tourism receipts"}),
  ...
  who({id:"physicians",name:"Most physicians per person",shortName:"Physicians",indicator:"SH.MED.PHYS.ZS",icon:"🧑‍⚕️",unit:"per 1,000 people",family:"Health",direction:"high",description:"Physicians per 1,000 people",decimals:2}),
  who({id:"hospitalBeds",name:"Most hospital beds per person",shortName:"Hospital beds",indicator:"SH.MED.BEDS.ZS",icon:"🛏️",unit:"per 1,000 people",family:"Health",direction:"high",description:"Hospital beds per 1,000 people",decimals:1}),
  ...
  who({id:"under5Mortality",name:"Lowest under-5 mortality",shortName:"Under-5 mortality",indicator:"SH.DYN.MORT",icon:"🧸",unit:"per 1,000",family:"Health",direction:"low",description:"Deaths before age five per 1,000 live births",decimals:1}),
  who({id:"maternalMortality",name:"Lowest maternal mortality",shortName:"Maternal mortality",indicator:"SH.STA.MMRT",icon:"🤱",unit:"per 100,000",family:"Health",direction:"low",description:"Maternal deaths per 100,000 live births",decimals:0,minimumYear:2015}),
  ...
  unesco({id:"secondaryEnrollment",name:"Highest secondary enrollment",shortName:"Secondary enrollment",indicator:"SE.SEC.ENRR",icon:"🏫",unit:"% gross",family:"Education",direction:"high",description:"Gross secondary-school enrollment ratio",decimals:1,expectedRange:[0,200]}),
  unesco({id:"tertiaryEnrollment",name:"Highest tertiary enrollment",shortName:"Tertiary enrollment",indicator:"SE.TER.ENRR",icon:"🎓",unit:"% gross",family:"Education",direction:"high",description:"Gross tertiary-school enrollment ratio",decimals:1,expectedRange:[0,200]}),
  ...
  who({id:"dptImmunization",name:"Highest DPT immunization rate",shortName:"DPT immunization",indicator:"SH.IMM.IDPT",icon:"💉",unit:"%",family:"Health",direction:"high",description:"Children ages 12–23 months receiving DPT vaccination",decimals:1,expectedRange:[0,100],coverageFloor:120}),
  who({id:"measlesImmunization",name:"Highest measles immunization rate",shortName:"Measles immunization",indicator:"SH.IMM.MEAS",icon:"🛡️",unit:"%",family:"Health",direction:"high",description:"Children ages 12–23 months receiving measles vaccination",decimals:1,expectedRange:[0,100],coverageFloor:120}),
  who({id:"nurses",name:"Most nurses and midwives per person",shortName:"Nurses and midwives",indicator:"SH.MED.NUMW.P3",icon:"🩺",unit:"per 1,000 people",family:"Health",direction:"high",description:"Nurses and midwives per 1,000 people",decimals:2,coverageFloor:70}),
  unesco({id:"primaryEnrollment",name:"Highest primary enrollment",shortName:"Primary enrollment",indicator:"SE.PRM.ENRR",icon:"📚",unit:"% gross",family:"Education",direction:"high",description:"Gross primary-school enrollment ratio",decimals:1,expectedRange:[0,200],coverageFloor:100}),
  unesco({id:"femaleSecondaryEnrollment",name:"Highest female secondary enrollment",shortName:"Female secondary enrollment",indicator:"SE.SEC.ENRR.FE",icon:"👩‍🎓",unit:"% gross",family:"Education",direction:"high",description:"Female gross secondary-school enrollment ratio",decimals:1,expectedRange:[0,200],coverageFloor:90}),
  unesco({id:"maleSecondaryEnrollment",name:"Highest male secondary enrollment",shortName:"Male secondary enrollment",indicator:"SE.SEC.ENRR.MA",icon:"👨‍🎓",unit:"% gross",family:"Education",direction:"high",description:"Male gross secondary-school enrollment ratio",decimals:1,expectedRange:[0,200],coverageFloor:90}),
  unesco({id:"primaryCompletion",name:"Highest primary completion rate",shortName:"Primary completion",indicator:"SE.PRM.CMPT.ZS",icon:"✅",unit:"%",family:"Education",direction:"high",description:"Primary completion rate, total",decimals:1,expectedRange:[0,150],coverageFloor:90}),
  tourism({id:"tourismReceiptsShare",name:"Highest tourism-receipts dependence",shortName:"Tourism receipts share",indicator:"ST.INT.RCPT.XP.ZS",icon:"🌍",unit:"% of exports",family:"Tourism",direction:"high",description:"International tourism receipts as a share of total exports",decimals:1,expectedRange:[0,100],coverageFloor:80}),
  tourism({id:"tourismDepartures",name:"Most international tourist departures",shortName:"Tourist departures",indicator:"ST.INT.DPRT",icon:"🛫",unit:"departures",family:"Tourism",direction:"high",description:"International outbound tourist departures",coverageFloor:80}),
  ...
  fao({id:"faoTea",name:"Largest tea producer",shortName:"Tea production",indicator:"667:2510",icon:"🍵",unit:"tonnes",family:"FAOSTAT cash crops",direction:"high",description:"Production quantity of tea leaves",minimumYear:2019,expectedRange:[0,10000000],coverageFloor:40}),
  fao({id:"faoSugarCane",name:"Largest sugar-cane producer",shortName:"Sugar-cane production",indicator:"156:2510",icon:"🎋",unit:"tonnes",family:"FAOSTAT cash crops",direction:"high",description:"Production quantity of sugar cane",minimumYear:2019,expectedRange:[0,3000000000],coverageFloor:85}),
  fao({id:"faoSoybeans",name:"Largest soybean producer",shortName:"Soybean production",indicator:"236:2510",icon:"🫘",unit:"tonnes",family:"FAOSTAT oil crops",direction:"high",description:"Production quantity of soybeans",minimumYear:2019,expectedRange:[0,1000000000],coverageFloor:80}),
  fao({id:"faoGroundnuts",name:"Largest groundnut producer",shortName:"Groundnut production",indicator:"242:2510",icon:"🥜",unit:"tonnes",family:"FAOSTAT oil crops",direction:"high",description:"Production quantity of groundnuts, excluding shelled",minimumYear:2019,expectedRange:[0,100000000],coverageFloor:80}),
  fao({id:"faoSunflower",name:"Largest sunflower-seed producer",shortName:"Sunflower production",indicator:"267:2510",icon:"🌻",unit:"tonnes",family:"FAOSTAT oil crops",direction:"high",description:"Production quantity of sunflower seed",minimumYear:2019,expectedRange:[0,100000000],coverageFloor:65}),
  fao({id:"faoCottonSeed",name:"Largest cotton-seed producer",shortName:"Cotton-seed production",indicator:"329:2510",icon:"🧵",unit:"tonnes",family:"FAOSTAT oil crops",direction:"high",description:"Production quantity of cotton seed",minimumYear:2019,expectedRange:[0,100000000],coverageFloor:60}),
