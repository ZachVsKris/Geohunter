...
export type DailyDifficulty = "easy" | "expert";
...
// Random challenges continue to use the approachable Normal format.
export const DEFAULT_DIFFICULTY: DailyDifficulty = "easy";
export const CATEGORY_COUNT = ROUND_CONFIGS.easy.categoryCount;
export const COUNTRY_COUNT = ROUND_CONFIGS.easy.countryCount;
export const DECOY_COUNT = ROUND_CONFIGS.easy.decoyCount;
export const MAX_SCORE = ROUND_CONFIGS.easy.maxScore;
export const TOP_FINISH_RANK = ROUND_CONFIGS.easy.topFinishRank;
export const MIN_ROUND_TYPES = ROUND_CONFIGS.easy.minRoundTypes;
...
export function roundHasRequiredDiversity(categories: Category[], config: RoundConfig = ROUND_CONFIGS.easy) {
