...
type PendingScore = { challengeDate: string; difficulty: "easy" | "expert"; assignments: Record<string, string> };
type Props = { pendingScore?: PendingScore; results?: boolean; difficulty?: "easy" | "expert" };

const pendingKey = (difficulty: "easy" | "expert") => `geostats-pending-daily-score-${difficulty}`;
    ...
    try {
      for (const difficulty of ["easy", "expert"] as const) {
        ...
        if (response.ok) {
          ...
          setMessage(`${difficulty === "expert" ? "Expert" : "Normal"} Daily score saved to your account.`);
