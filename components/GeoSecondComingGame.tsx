...
export default function GeoSecondComingGame() {
  ...
  return <div className={`shell ${round && !scores ? "activePlay" : ""}`}>
    ...
    {status && <div className="loading"><div className="spinner"/><strong>{status}</strong><span>Only a small candidate set is loaded. Successful data is reused across rounds and page refreshes during this browser session.</span></div>}
