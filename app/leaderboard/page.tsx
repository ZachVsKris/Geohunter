...
export default function LeaderboardPage() {
  return <main className="shell standalonePage">
    <header>
      ...
      <div className="headerButtons"><a className="headerButtonLink" href="/daily">Normal Daily</a><a className="headerButtonLink" href="/daily/expert">Expert Daily</a><AccountControls /></div>
    </header>
    <LeaderboardView />
  </main>;
}
