...
export default function DataPage(){return <main style={{maxWidth:1000,margin:"40px auto",padding:20}}>
  ...
  <p>This experimental build uses 76 World Bank World Development Indicators categories on the known-fast v9 baseline. Each ranking keeps the same contradiction, coverage, tie, and recency checks.</p>
