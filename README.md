# GeoStats v11.1.0 — Eight Countries, Six Categories
...
- 2 unused countries
- 600 maximum points
- 1st through 8th score 100, 90, 80, 70, 60, 50, 40, and 30 points
...
Rules version is now `3.0`. A Daily board already stored for the current date remains unchanged until the next New York midnight; the next Daily is generated in the new format. All-time leaderboard calculations use Rules 3.0 scores only so 800-point and 600-point eras are not mixed.
