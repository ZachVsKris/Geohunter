...
## v11.0.2 automatic Daily persistence

The Daily flow is fully automatic. The app first checks Supabase for today's board. If none exists, it uploads either the browser-cached Daily or a newly generated Daily through the server route. No manual daily inserts are required.
